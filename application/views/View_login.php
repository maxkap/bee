...
<div class="container">
    ...
    <form class="form-signin">
        ...
        <input type="text" class="input-block-level" name="login" required="" placeholder="Login">
        <input type="password" class="input-block-level" name="password" required="" placeholder="Password">
